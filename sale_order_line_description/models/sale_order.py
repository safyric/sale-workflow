...
class SaleOrderLine(models.Model):
    ...
    def _get_sale_order_line_multiline_description_variants(self):
        ...
        for pav in self.product_id.attribute_value_ids.filtered(
            lambda pav: pav.attribute_id not in product_attribute_with_is_custom and pav.code != "0" and pav.code !="00" and pav.code !="000"
        ):
        ...
        for pvav in self.product_no_variant_attribute_value_ids.filtered(
            lambda pvav: pvav.attribute_id not in product_attribute_with_is_custom and pvav.code != "0" and pvav.code != "00" and pav.code !="000"
        ):
            if self.order_id.is_long_description:
